...
public class AskQuestionService extends AsyncTask<String, String, String> {

    CustomDialog customDialog;
    Activity activity;
    Interface.OnAskQuestion onAskQuestion;
    String Result;
    String Question,UserId;

    public AskQuestionService(Activity activity, Interface.OnAskQuestion onAskQuestion, String question, String userId) {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            Form form = new Form()
                    .add(Constants.action, Constants.createquery)
                    .add(Constants.text, Question)
                    .add(Constants.userid, UserId)
                    .add(Constants.appid, GlobalClass.Riyadh);

            Request request = Bridge
                    .post(Constants.URL + "/" + Constants.ContactQueryProcess)
                    .body(form)
                    .request();
        ...
        try {
            if (!s.equals("Error")) {
                ...
                if (jsonObject.getInt("status") == Constants.Success) {
                    onAskQuestion.onAskQuestion(jsonObject);
                } else {
